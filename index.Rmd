...
show if there is a relationship between two numeric variables and to see if there
is any possible correlation. To test to see if weeks and initial cases had
correlation (that is as one goes through the weeks of the pandemic, it would
be apparent that there is a relationship between week and cases), however to this
